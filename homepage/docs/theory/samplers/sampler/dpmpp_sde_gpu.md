...
**ComfyUI 함수 시그니처**
`sample_dpmpp_sde_gpu(model, x, sigmas, extra_args=None, callback=None, disable=None, eta=1., s_noise=1., noise_sampler=None, r=1 / 2)`
...
**ComfyUI 경로:** `comfy/k_diffusion/sampling.py::sample_dpmpp_sde_gpu`
