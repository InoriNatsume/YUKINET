...
family: DPMstochastic: yescfg_pp: nogpu_variant: nostandalone: no
**ComfyUI 함수 시그니처**
`sample_dpm_2_ancestral(model, x, sigmas, extra_args=None, callback=None, disable=None, eta=1., s_noise=1., noise_sampler=None)`
...
**ComfyUI 경로:** `comfy/k_diffusion/sampling.py::sample_dpm_2_ancestral`
