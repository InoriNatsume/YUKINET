...
family: DPM++stochastic: yescfg_pp: nogpu_variant: nostandalone: no
**ComfyUI 함수 시그니처**
`sample_dpmpp_3m_sde(model, x, sigmas, extra_args=None, callback=None, disable=None, eta=1., s_noise=1., noise_sampler=None)`

**docstring:** DPM-Solver++(3M) SDE.
$$ x_{k+1}=\Phi_{\mathrm{base}}+\phi_2(h_\eta)d_1-\phi_3(h_\eta)d_2+\Phi_{\mathrm{noise}} $$
...
**ComfyUI 경로:** `comfy/k_diffusion/sampling.py::sample_dpmpp_3m_sde`
