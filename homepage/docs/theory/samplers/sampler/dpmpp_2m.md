...
# Sampler: dpmpp_2m
family: DPM++stochastic: nocfg_pp: nogpu_variant: nostandalone: no
**ComfyUI 함수 시그니처**
`sample_dpmpp_2m(model, x, sigmas, extra_args=None, callback=None, disable=None)`
...
**ComfyUI 경로:** `comfy/k_diffusion/sampling.py::sample_dpmpp_2m`
