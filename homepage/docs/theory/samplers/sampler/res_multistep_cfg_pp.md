...
family: Linear/Residual Multistepstochastic: nocfg_pp: yesgpu_variant: nostandalone: no
**ComfyUI 함수 시그니처**
`sample_res_multistep_cfg_pp(model, x, sigmas, extra_args=None, callback=None, disable=None, s_noise=1., noise_sampler=None)`
...
**대상:** `res_multistep_cfg_pp` / **family:** Linear/Residual Multistep
...
**ComfyUI 경로:** `comfy/k_diffusion/sampling.py::sample_res_multistep_cfg_pp`
