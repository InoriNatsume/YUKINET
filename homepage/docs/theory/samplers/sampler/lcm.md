...
# Sampler: lcm
**ComfyUI 함수 시그니처**
`sample_lcm(model, x, sigmas, extra_args=None, callback=None, disable=None, noise_sampler=None)`
...
**ComfyUI 경로:** `comfy/k_diffusion/sampling.py::sample_lcm`
