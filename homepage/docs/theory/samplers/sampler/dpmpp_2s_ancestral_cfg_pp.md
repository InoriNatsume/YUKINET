...
family: DPM++stochastic: yescfg_pp: yesgpu_variant: nostandalone: no
**ComfyUI 함수 시그니처**
`sample_dpmpp_2s_ancestral_cfg_pp(model, x, sigmas, extra_args=None, callback=None, disable=None, eta=1., s_noise=1., noise_sampler=None)`

**docstring:** Ancestral sampling with DPM-Solver++(2S) second-order steps.
...
**대상:** `dpmpp_2s_ancestral_cfg_pp` / **family:** DPM++
...
**ComfyUI 경로:** `comfy/k_diffusion/sampling.py::sample_dpmpp_2s_ancestral_cfg_pp`
