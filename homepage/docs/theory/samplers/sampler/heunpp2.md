...
# Sampler: heunpp2
family: Heun/ExpHeunstochastic: nocfg_pp: nogpu_variant: nostandalone: no
**ComfyUI 함수 시그니처**
`sample_heunpp2(model, x, sigmas, extra_args=None, callback=None, disable=None, s_churn=0., s_tmin=0., s_tmax=float('inf'), s_noise=1.)`
...
**대상:** `heunpp2` / **family:** Heun/ExpHeun
...
**ComfyUI 경로:** `comfy/k_diffusion/sampling.py::sample_heunpp2`
