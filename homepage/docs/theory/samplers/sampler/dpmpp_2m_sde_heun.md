...
**ComfyUI 함수 시그니처**
`sample_dpmpp_2m_sde_heun(model, x, sigmas, extra_args=None, callback=None, disable=None, eta=1., s_noise=1., noise_sampler=None, solver_type='heun')`
...
**대상:** `dpmpp_2m_sde_heun` / **family:** DPM++
...
**ComfyUI 경로:** `comfy/k_diffusion/sampling.py::sample_dpmpp_2m_sde_heun`
...
| solver_type | 'heun' | 보정 방식(midpoint/heun 등) 선택 | Basic KSampler 미노출. Custom Sampling 노드/코드(extra_options)에서 제어. |
