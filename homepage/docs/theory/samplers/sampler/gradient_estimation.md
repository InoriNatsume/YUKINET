...
family: Gradient Estimationstochastic: nocfg_pp: nogpu_variant: nostandalone: no
**ComfyUI 함수 시그니처**
`sample_gradient_estimation(model, x, sigmas, extra_args=None, callback=None, disable=None, ge_gamma=2., cfg_pp=False)`

**docstring:** Gradient-estimation sampler. Paper: https://openreview.net/pdf?id=o2ND9v0CeK
...
**대상:** `gradient_estimation` / **family:** Gradient Estimation
...
**ComfyUI 경로:** `comfy/k_diffusion/sampling.py::sample_gradient_estimation`
...
| cfg_pp | False | sampler-specific control parameter | 맥락 의존. |
...
| cfg_pp | $cfg_pp$ | 구현 의존 | sampler-specific tuning parameter |
