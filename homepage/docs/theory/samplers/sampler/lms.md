...
# Sampler: lms
**ComfyUI 함수 시그니처**
`sample_lms(model, x, sigmas, extra_args=None, callback=None, disable=None, order=4)`
...
**대상:** `lms` / **family:** Linear/Residual Multistep
...
**ComfyUI 경로:** `comfy/k_diffusion/sampling.py::sample_lms`
...
|---|---|---|---|
| order | 4 | 솔버 차수 | Basic KSampler 미노출. Custom Sampling 노드/코드(extra_options)에서 제어. |
