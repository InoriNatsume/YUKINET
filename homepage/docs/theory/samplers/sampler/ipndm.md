...
**ComfyUI 함수 시그니처**
`sample_ipndm(model, x, sigmas, extra_args=None, callback=None, disable=None, max_order=4)`
...
**ComfyUI 경로:** `comfy/k_diffusion/sampling.py::sample_ipndm`
